...
class PedidoController extends \Com\Daw2\Core\BaseController {
    ...
    function mostrarTodos() {
        ...
        $data['pedidos'] = $model->getAll();
        $this->view->showViews(array('templates/header.view.php', 'templates/left-menu.view.php', 'pedidos.view.php', 'templates/footer.view.php'), $data);
    }
